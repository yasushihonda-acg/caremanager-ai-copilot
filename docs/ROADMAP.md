...
| フィードバックFAB・利用ログ | アプリ内フィードバック・Cloud Logging連携 | ✅ |
| #22: 期限アラート | 認定有効期限・モニタリング期限（60/30日前・超過）ADR 0011準拠 | ✅ |
| #23: オンボーディング | 4ステップモーダルツアー（初回自動・メニューから再表示） | ✅ |
| #24: ダッシュボード | 期限アラート・最近の利用者・件数サマリー・クイックアクション | ✅ |
| #49: プライバシーポリシー | ポリシーページ・同意確認ダイアログ・Firestore記録 | ✅ |
| #50: ヘルプページ | 使い方ガイド（操作説明・FAQ） | ✅ |
| #53: PWA化・オフラインUX | vite-plugin-pwa・Firestoreオフラインキャッシュ・OfflineBanner | ✅ |
