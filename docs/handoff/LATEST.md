...
## 直近の変更（セッション14: 期限アラート・#18-21デプロイ完了）

| 日付 | コミット | 内容 |
|------|----------|------|
| 2026-02-19 | 77116b2 | feat: 認定有効期限・モニタリング期限アラート (#22) |
| 2026-02-19 | ee97f95 | docs: Stage 3タスク状況更新（#18-21 デプロイ完了） |
| 2026-02-19 | eacf137 | feat: P0法定要件・実用性・互換性 一括対応（#18-21） (#34) |
...
| Issue | 内容 | コミット |
|-------|------|----------|
| #22 | 認定有効期限・モニタリング期限アラート（utils/deadlineAlerts.ts、32テスト、ADR 0011） | 77116b2 |
